...
**1.** Fork [this](https://github.com/judevhub/DevConnect) repository.
Click on the <a href="https://github.com/judevhub/DevConnect//"><img src="https://img.icons8.com/ios/24/000000/code-fork.png"></a> symbol at the top right corner.

**2.** Clone the forked repository.

```bash
git clone https://github.com/<your-github-username>/DevConnect
```
...
>CAUTION: Synch up your local repo with [original repo](https://github.com/judevhub/DevConnect/) (Upstream) before pushing your commits.
...
>```bash
>#Add upstream repo
>git remote add upstream https://github.com/judevhub/DevConnect/.git
>
...
**9.** **Congratulations!** Sit and relax, you've made your contribution to DevConnect project.